...
using UnityEngine;
public class Fish_Rotation_Right : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (flg == 0)
        {
            ...
            {
                flg = 1;
                //path1 = BezierUtils.GetBeizerList(Fish_Rotation.transform.position, new Vector3(Fish_Rotation.transform.position.x - 1.25f, Fish_Rotation.transform.position.y - 0.75f, 0), new Vector3(Fish_Rotation.transform.position.x, Fish_Rotation.transform.position.y - 1.5f, 0), 30);
